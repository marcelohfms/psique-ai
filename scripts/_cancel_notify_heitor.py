...
async def main():
    ...
    msg = payment_cancel_message(contact_first, "Dr. Júlio", "17/06/2026 às 16:00", patient_first)
    print(f"Mensagem:\n{msg}\n")
    ...
    await send_clinic_notification_email(
        ...
        f"Médico(a): Dr. Júlio\nData/hora: 17/06/2026 às 16:00\nWhatsApp: {phone}\n\n"
        f"A vaga foi liberada. Aviso ao paciente enviado manualmente em 11/06 "
        f"(cancelamento ocorreu em 09/06 sem notificação — bug corrigido)."
    )
